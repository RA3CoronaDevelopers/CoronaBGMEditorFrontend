                ...
                <Grid container spacing={1}>
                  ...
                  <Grid item xs={11}>
                    <Grid container spacing={1}>
                      ...
                      {[
                        { type: 'targetOffset', label: '目标轨道位置(s)', xs: 4 },
                        { type: 'fadeOutDelay', label: '渐出延迟时间(s)', xs: 3 },
                        { type: 'fadeOutDuration', label: '渐出持续时间(s)', xs: 3 },
                        { type: 'targetFadeInDelay', label: '渐入延迟时间(s)', xs: 3 },
                        { type: 'targetFadeInDuration', label: '渐入持续时间(s)', xs: 3 }
                      ].map(({ type, label, xs }) => <Grid item xs={xs as GridSize}>
                        <TextField
                          variant='outlined'
